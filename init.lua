...
vim.keymap.set("n", "<leader>S", 'viwc""<Esc>hp', { noremap = true, silent = true })
...
local explorer = require "custom/utils/reveal-in-explorer"
vim.keymap.set(
  "n",
  "<leader>se",
  explorer.reveal_in_explorer,
  { noremap = true, silent = true, desc = "Reveal In File Explorer" }
)
